...
def main():
    ...
    objectPoints = None
    if MULTIPLE_PLANES:
        bg_mask, fg_mask, planes = calibrate_planes(mtx, rotM, real_word_position, image_no_shadow)
        shadow_plane = light_calibration(image, mtx, rotM, real_word_position, planes, mask = bg_mask)
